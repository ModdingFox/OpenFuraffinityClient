    ...
    protected void fetchPageData() {
        if (getArguments() != null) {
            ...
            if (submissionDescription.equals(commissions.class.getName())) {
                abstractPage = new open.furaffinity.client.pages.commissions(getActivity(),
                    new abstractPage.pageListener() {
                        @Override public void requestSucceeded(abstractPage abstractPage) {
                            mData = "<table>" +
                                ((open.furaffinity.client.pages.commissions) abstractPage).getCommissionBodyBody() +
                                "</table>";
                            updateUIElements();
                        }
                ...
                abstractPage = new open.furaffinity.client.pages.journal(getActivity(),
                    new abstractPage.pageListener() {
                        @Override public void requestSucceeded(abstractPage abstractPage) {
                            mData = "<table>" +
                                ((open.furaffinity.client.pages.journal) abstractPage).getJournalContent() +
                                "</table>";
                            updateUIElements();
                        }
                ...
                abstractPage = new open.furaffinity.client.pages.view(getActivity(),
                    new abstractPage.pageListener() {
                        @Override public void requestSucceeded(abstractPage abstractPage) {
                            mData = "<table>" +
                                ((open.furaffinity.client.pages.view) abstractPage).getSubmissionDescription() +
                                "</table>";
                            updateUIElements();
                        }
                ...
                abstractPage = new open.furaffinity.client.pages.msgPmsMessage(getActivity(),
                    new abstractPage.pageListener() {
                        @Override public void requestSucceeded(abstractPage abstractPage) {
                            mData = "<table>" +
                                ((open.furaffinity.client.pages.msgPmsMessage) abstractPage).getMessageBody() +
                                "</table>";
                            updateUIElements();
                        }
