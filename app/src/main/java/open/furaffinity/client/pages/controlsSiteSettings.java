...
public class controlsSiteSettings extends AsyncTask<webClient, Void, Void> {
    ...
    public boolean getDisableAvatars() { return disable_avatars; }
    public String getDateFormat() { return date_format; }
    public HashMap<String,String> getPerPage() { return perpage; }
    public String getPerPageCurrent() { return perpage_current; }
    public HashMap<String,String> getNewSubmissionsDirection() { return newsubmissions_direction; }
    public String getNewSubmissionsDirectionCurrent() { return newsubmissions_direction_current; }
    public HashMap<String,String> getThumbnailSize() { return thumbnail_size; }
    public String getThumbnailSizeCurrent() { return thumbnail_size_current; }
    public String getGalleryNavigation() { return gallery_navigation; }
    public HashMap<String,String> getHideFavorites() { return hide_favorites; }
    public String getHideFavoritesCurrent() { return hide_favorites_current; }
    public HashMap<String,String> getNoGuests() { return no_guests; }
    public String getNoGuestsCurrent() { return no_guests_current; }
    public HashMap<String,String> getNoSearchEngines() { return no_search_engines; }
    public String getNoSearchEnginesCurrent() { return no_search_engines_current; }
    public HashMap<String,String> getNoNotes() { return no_notes; }
    public String getNoNotesCurrent() { return no_notes_current; }
