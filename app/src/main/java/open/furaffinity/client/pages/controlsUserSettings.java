...
public class controlsUserSettings extends AsyncTask<webClient, Void, Void> {
    ...
    public boolean getAcceptTrades() { return accept_trades; }
    public boolean getAcceptCommissions() { return accept_commissions; }

    public HashMap<String, String> getFeaturedJournalId() { return featured_journal_id; }
    public String getFeaturedJournalIdCurrent() { return featured_journal_id_current; }
