...
public class msgOthers extends abstractPage {
    ...
    public static List<HashMap<String, String>> processWatchNotifications(String html,
                                                                          String actionText) {
        ...
        if (html != null && html.length() > 0) {
            ...
            for (Element currentElement : listElements) {
                ...
                Element currentElementAvatarDivAImg =
                    currentElementAvatarDivA.selectFirst("img.avatar");

                Element currentElementInputCheckbox =
                    currentElement.selectFirst("input[type=checkbox]");
                ...
                Element currentElementInfoDivSpanPopupDate =
                    currentElementInfoDiv.selectFirst("span.popup_date");

                open.furaffinity.client.utilities.html.correctHtmlAHrefAndImgScr(
                    currentElementAvatarDivAImg);
                ...
                currentElementResult.put("notificationId",
                    currentElementInputCheckbox.attr("value"));
    ...
    public static List<HashMap<String, String>> processShoutNotifications(String html,
                                                                          String actionText) {
        List<HashMap<String, String>> result = new ArrayList<>();
        ...
        if (html != null && html.length() > 0) {
            ...
            for (Element currentElement : listElements) {
                ...
                if (currentElementAHref != null && currentElementStrong != null &&
                    currentElementSpan != null) {
                    ...
                    currentElementResult.put("actionText",
    ...
    public static List<HashMap<String, String>> processLineNotifications(String html,
                                                                         String actionText) {
        List<HashMap<String, String>> result = new ArrayList<>();
    ...
    public static List<HashMap<String, String>> processJournalLineNotifications(String html,
                                                                                String actionText) {
        List<HashMap<String, String>> result = new ArrayList<>();
    ...
    public static List<HashMap<String, String>> processJournalNotifications(String html,
                                                                            String actionText) {
        List<HashMap<String, String>> result = new ArrayList<>();
    ...
    protected Boolean processPageData(String html) {
        ...
        Element msgOthersMessagesWatchesMessageStream =
            doc.selectFirst("section[id=messages-watches]");
        ...
        Element msgOthersMessagesCommentsSubmissionMessageStream =
            doc.selectFirst("section[id=messages-comments-submission]");
        if (msgOthersMessagesCommentsSubmissionMessageStream != null) {
            submissionComments =
                msgOthersMessagesCommentsSubmissionMessageStream.selectFirst("ul.message-stream")
                    .html();
        }

        Element msgOthersMessagesCommentsJournalMessageStream =
            doc.selectFirst("section[id=messages-comments-journal]");
        if (msgOthersMessagesCommentsJournalMessageStream != null) {
            journalComments =
                msgOthersMessagesCommentsJournalMessageStream.selectFirst("ul.message-stream")
                    .html();
        }

        Element msgOthersMessagesShoutsMessageStream =
            doc.selectFirst("section[id=messages-shouts]");
        ...
        Element msgOthersMessagesFavoritesMessageStream =
            doc.selectFirst("section[id=messages-favorites]");
        if (msgOthersMessagesFavoritesMessageStream != null) {
            favorites =
                msgOthersMessagesFavoritesMessageStream.selectFirst("ul.message-stream").html();
        }

        Element msgOthersMessagesJournalsMessageStream =
            doc.selectFirst("section[id=messages-journals]");
        if (msgOthersMessagesJournalsMessageStream != null) {
            journals =
                msgOthersMessagesJournalsMessageStream.selectFirst("ul.message-stream").html();
        }
