...
public class journal extends appFragment {
    ...
    private void saveHistory() {
        ...
        if (sharedPref.getBoolean(requireActivity().getString(R.string.trackHistorySetting),
            ...
            db.execSQL("DELETE FROM " + historyContract.historyItemEntry.TABLE_NAME_JOURNAL +
    ...
    private void setupViewPager(open.furaffinity.client.pages.journal page) {
        journalSectionsPagerAdapter sectionsPagerAdapter =
    ...
    protected void updateUIElementListeners(View rootView) {
        journalLinearLayout.setOnClickListener(
            v -> ((mainActivity) requireActivity()).setUserPath(page.getJournalUserLink()));
        ...
        sendNote.setOnClickListener(
            v -> sendPM(getActivity(), getChildFragmentManager(), page.getNoteUser()));
