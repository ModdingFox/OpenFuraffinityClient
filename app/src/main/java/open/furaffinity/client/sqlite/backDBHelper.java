...
public class backDBHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_BACK_HISTORY_TABLE_END =
        "(" + backItemEntry.COLUMN_NAME_FRAGMENT_NAME + " TEXT," +
            backItemEntry.COLUMN_NAME_FRAGMENT_DATA + " TEXT," +
            backItemEntry.COLUMN_NAME_DATETIME + " DATETIME" + ")";
    ...
    @Override public void onCreate(SQLiteDatabase db) {
        db.execSQL(SQL_CREATE_BACK_HISTORY_TABLE_START + backItemEntry.TABLE_NAME_BACK_HISTORY +
            SQL_CREATE_BACK_HISTORY_TABLE_END);
    }
