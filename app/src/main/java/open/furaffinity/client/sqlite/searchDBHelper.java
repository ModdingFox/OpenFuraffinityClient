...
public class searchDBHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_HISTORY_TABLE_END = "(" +
            ...
            searchItemEntry.COLUMN_NAME_MOSTRECENTITEM + " TEXT," +
            searchItemEntry.COLUMN_NAME_Q + " TEXT," +
            searchItemEntry.COLUMN_NAME_ORDERBY + " TEXT," +
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(SQL_CREATE_HISTORY_TABLE_START + searchItemEntry.TABLE_NAME + SQL_CREATE_HISTORY_TABLE_END);
    }
