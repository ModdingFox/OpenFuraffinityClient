...
public class HistoryDBHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_HISTORY_TABLE_END =
        "(" + historyItemEntry.COLUMN_NAME_USER + " TEXT," + historyItemEntry.COLUMN_NAME_TITLE +
            " TEXT," + historyItemEntry.COLUMN_NAME_URL + " TEXT," +
            historyItemEntry.COLUMN_NAME_DATETIME + " DATETIME" + ")";
    ...
    @Override public void onCreate(SQLiteDatabase db) {
        db.execSQL(SQL_CREATE_HISTORY_TABLE_START + historyItemEntry.TABLE_NAME_JOURNAL +
            SQL_CREATE_HISTORY_TABLE_END);
        db.execSQL(SQL_CREATE_HISTORY_TABLE_START + historyItemEntry.TABLE_NAME_USER +
            SQL_CREATE_HISTORY_TABLE_END);
        db.execSQL(SQL_CREATE_HISTORY_TABLE_START + historyItemEntry.TABLE_NAME_VIEW +
            SQL_CREATE_HISTORY_TABLE_END);
    }
