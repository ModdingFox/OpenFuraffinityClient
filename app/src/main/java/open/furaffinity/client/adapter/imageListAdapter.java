...
public class imageListAdapter extends RecyclerView.Adapter<imageListAdapter.ViewHolder> {
    ...
    public imageListAdapter(List<HashMap<String, String>> mDataSetIn, Activity activity,
        ...
        this.loginCheck =
            new open.furaffinity.client.pages.loginCheck(context, new abstractPage.pageListener() {
        ...
        switch (holder.getItemViewType()) {
            case 0:
                ...
                holder.menuButton.setOnClickListener(v -> {
                    ...
                    open.furaffinity.client.pages.view viewPage =
                    ...
                    open.furaffinity.client.pages.user userPage =
                    ...
                    popupMenu.setOnMenuItemClickListener(item -> {
                        ...
                        switch (item.getItemId()) {
                            case R.id.menu_download:
                                open.furaffinity.client.utilities.downloadContent.downloadSubmission(
                            ...
                            case R.id.menu_favUnfav:
                                new open.furaffinity.client.submitPages.submitGetRequest(context,
                                    new abstractPage.pageListener() {
                                        @Override
                ...
                holder.itemView.setOnClickListener(v -> ((mainActivity) context).setViewPath(
                    mDataSet.get(position).get("postPath")));
                break;
            case 1:
                new AsyncTask<Void, Void, Void>() {
                    @Override protected Void doInBackground(Void... voids) {
                        open.furaffinity.client.utilities.webClient webClient =
                            new open.furaffinity.client.utilities.webClient(context);
