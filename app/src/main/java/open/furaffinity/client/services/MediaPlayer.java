...
public class MediaPlayer extends Service {
    ...
    @Override public void onCreate() {
        ...
        notificationCompatMediaStyle = new NotificationCompat.MediaStyle().setMediaSession(
    ...
    public class mediaPlayerBinder extends Binder {
        public void playURL(String url, String artist, String title) {
            ...
            mediaSessionCompat.setMetadata(
                new MediaMetadataCompat.Builder().putString(MediaMetadata.METADATA_KEY_ALBUM_ARTIST,
                    artist).putString(MediaMetadata.METADATA_KEY_TITLE, title).build());

            androidx.core.app.NotificationCompat.Builder mBuilder =
                new androidx.core.app.NotificationCompat.Builder(MediaPlayer.this,
                    getString(R.string.musicPlayerService)).setStyle(notificationCompatMediaStyle)
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                NotificationChannel channel = new NotificationChannel(channelId,
                    getString(R.string.musicPlayerService) + "_Service_channel",
